...
<section class="d-flex justify-content-center align-items-center vh-100 gap-0">
    <div class="card  p-4 login-card2 d-flex flex-column align-self-center justify-content-center login-container rounded-0" >
        <form action="./build/config/startSession.php" class="formlogin d-flex flex-column align-self-center justify-content-center" method="POST">
            ...
            <div>
                ...
                <legend class="legend-border mb-2 text-white fs-3">Matrícula: </legend>
                    <input type="text" class="form-control letra2 input-borde input-bg fw-bold" id="matricula" name="user">
            ...
            <div>
                ...
                <legend class="legend-border mb-2 text-white fs-3">Correo: </legend>
                    <input type="text" class="form-control letra2 input-borde input-bg fw-bold" id="correo" name="user">
